            ...
            <nav id="nav" className="navbar navbar-expand-lg navbar-light">
                <div className="container-fluid">
                    ...
                    <div className="">
                        ...
                        <h1 className="display-5 text-white text-uppercase m-2"><i className="fas fa-tree text-white m-2"></i>Alpha Tree Surgeons<i className="fas fa-tree text-white m-2"></i></h1>
